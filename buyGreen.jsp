...
<html lang = 'en'>
    <head>
        <title>Forest Green Background</title>
    ...
    <body>
        ...
        <div class = "navBar">
            ...
            <h1>Forest Green Background</h1> <br>	
            <nav>
                <ul class="mainMenu">
        ...
        <%
        	...
        	String screenname = null;
       		...
       		else
       		{
	        	...
	        	String query = "SELECT price FROM product WHERE name = 'Forest Green Web Background'";
	            ...
	            else
	            {
		            ...
		            out.println("<h1> Forest Green Web Background purchased </h1>");
	            }
       		}
        %>
    </body>
